...
mach::machine::register_table::register_table(){
	registers_["rax"] = registers_["r0"] = std::make_shared<qword_integer_register>();
	...
	registers_["rbx"] = registers_["r1"] = std::make_shared<qword_integer_register>();
	...
	registers_["rcx"] = registers_["r2"] = std::make_shared<qword_integer_register>();
	...
	registers_["rdx"] = registers_["r3"] = std::make_shared<qword_integer_register>();
	...
	registers_["rsp"] = registers_["r4"] = std::make_shared<qword_integer_register>();
	...
	registers_["rbp"] = registers_["r5"] = std::make_shared<qword_integer_register>();
	...
	registers_["rsi"] = registers_["r6"] = std::make_shared<qword_integer_register>();
	...
	registers_["rdi"] = registers_["r7"] = std::make_shared<qword_integer_register>();
	...
	registers_["rip"] = registers_["r8"] = std::make_shared<qword_integer_register>();
	...
	for (auto index = 0; index < 16; ++index){
		...
		registers_[key] = std::make_shared<qword_integer_register>();
